      ...
      >
        ...
        <div className="w-full justify-center items-center gap-2 flex flex-col">
          <InputBox
            ...
            selectCurrency={from}
          />
          <button onClick={Swap} className="bg-amber-400 p-2 rounded absolute">
            Swap
          </button>
          <InputBox
            label={"to"}
        ...
        <form
          action=""
          className="w-[95%] rounded-2xl bg-amber-500 sm:bg-transparent sm:text-white m-2 sm:m-0 sm:w-1/2 md:w-1/2"
          onSubmit={handleSubmit}
        >
          <div className="w-full text-2xl">
            <button
              type="submit"
              className="hover:w-full duration-500 md:text-nowrap relative group w-full md:w-0 md:hover:bg-amber-300 rounded p-2 my-2 h-full "
            >
              <span className="text-xl md:inline hidden text-red-600  group-hover:hidden duration-75 absolute w-1 h-[70%] bg-red-500 left-0"></span>
              Convert {from} to {to}{" "}
            </button>
          </div>
        </form>
